...
def plot_comparative_figures():
    ...
    files = {
        'P1: with summarized transaction': 'prediction_results_based_on_Transformer_Embeddings.csv',
        'P1: without summarized transaction': 'prediction_results_based_on_Transformer_Embeddings_Ablation.csv'
    }

    fixed_thresholds = {
        'P1: with summarized transaction': {
        ...
        'P1: without summarized transaction': {
            'AAE': 0.5,
            'RF': 0.5,
            'ET': 0.5,
            'XGB': 0.5,
